...
resource cacheAzurecontainerappsapphostA01ec9bc8dCacheDataFileShare 'Microsoft.Storage/storageAccounts/fileServices/shares@2022-05-01' = {
  parent: storageVolumeFileService
  name: take('${toLower('cache')}-${toLower('azurecontainerappsapphosta01ec9bc8dcachedata')}', 60)
  properties: {
    shareQuota: 1024
...
resource cacheAzurecontainerappsapphostA01ec9bc8dCacheDataStore 'Microsoft.App/managedEnvironments/storages@2023-05-01' = {
  parent: containerAppEnvironment
  name: take('${toLower('cache')}-${toLower('azurecontainerappsapphosta01ec9bc8dcachedata')}', 32)
  properties: {
    azureFile: {
      shareName: cacheAzurecontainerappsapphostA01ec9bc8dCacheDataFileShare.name
...
output SERVICE_CACHE_VOLUME_AZURECONTAINERAPPSAPPHOSTA01EC9BC8DCACHEDATA_NAME string = cacheAzurecontainerappsapphostA01ec9bc8dCacheDataStore.name
